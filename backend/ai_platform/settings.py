...
# Security settings
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-in-production-please')
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='ai_model_platform'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'AI Model Platform API',
    'DESCRIPTION': 'RESTful API for AI Model Platform - Manage users, developers, models, and interactions',
    'VERSION': '1.0.0',
